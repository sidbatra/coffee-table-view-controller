...
UITableViewController's current architecture results in bloated and disorganized table view controllers
because it becomes a hub for different types of code, including:
* View controller logic
* Initialization of table view cells
* Presentation of table view cells
* Downloading images
* Fetching or loading of data for table view cells

This added complexity makes it hard to manage table view controllers with:
* Lots of different types of cells 
* Multiple data sources, possible from different services
...
Coffee Table View Controller is a modular, scalable and DRY extension of UITableViewController. 



h2. Concepts

h3. CTableViewDataSource

h3. CTableViewController
